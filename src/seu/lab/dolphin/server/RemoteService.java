...
//	};
    ...
    private void createFloatView() {  
        ...
        Log.i("MainService", "mWindowManager--->" + mWindowManager);  
        ...
        Log.i(TAG, "Width/2--->" + mFloatRecordButton.getMeasuredWidth()/2);  
        Log.i(TAG, "Height/2--->" + mFloatRecordButton.getMeasuredHeight()/2);  
        ...
        mFloatRecordButton.setOnClickListener(new OnClickListener() {  
            ...
            public void onClick(View v) {  
                // Toast.makeText(MainService.this, "onClick", Toast.LENGTH_SHORT).show();
